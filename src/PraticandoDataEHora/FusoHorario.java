...
public class FusoHorario {
    public static void main(String[] args) {
        ...
        // Como a empresa tem clientes no Japão, o sistema deve ser capaz de mostrar o horário atual na cidade de Tóquio,
        ...
        ZonedDateTime fusoHorarioToquio = ZonedDateTime.now(ZoneId.of("Asia/Tokyo"));
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("HH:mm:ss");

        String formatado = fusoHorarioToquio.format(formatter);

        System.out.println("Horário atual em Tóquio: " + formatado);
